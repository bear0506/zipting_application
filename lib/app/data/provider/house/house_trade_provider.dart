...
class HouseTradeUpdateProvider {
  dio({dynamic houseIdx, dynamic requestModel}) async {
    final Dio dio = Dio();
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return HouseTradeBaseResponseModel.fromJson(response.data);
      } else {
