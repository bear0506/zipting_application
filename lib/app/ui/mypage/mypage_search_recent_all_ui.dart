...
class MyPageSearchRecentAllUi extends GetView<MyPageSearchRecentAllController> {
  const MyPageSearchRecentAllUi({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Expanded(
                    child: controller.isShimmerVisible.value == true
                        ? const SearchRecentShimmerWidget()
...
class SearchRecentWidget extends GetView<MyPageSearchRecentAllController> {
  const SearchRecentWidget({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) => Obx(
        () => controller.houses.isEmpty
            ? const SearchRecentContentEmptyWidget()
            : const SearchRecentContentWidget(),
      );
}

class SearchRecentContentEmptyWidget extends StatelessWidget {
  const SearchRecentContentEmptyWidget({Key? key}) : super(key: key);
...
class SearchRecentContentWidget
    extends GetView<MyPageSearchRecentAllController> {
  const SearchRecentContentWidget({Key? key}) : super(key: key);
...
class SearchRecentShimmerWidget extends StatelessWidget {
  const SearchRecentShimmerWidget({Key? key}) : super(key: key);
