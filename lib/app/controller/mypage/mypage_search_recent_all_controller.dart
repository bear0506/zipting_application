...
import 'package:zipting/app/data/model/mypage/mypage_search_recent_all_model.dart';
import 'package:zipting/app/data/model/wishlist/wishlist_model.dart';
import 'package:zipting/app/data/provider/mypage/mypage_search_recent_all_provider.dart';
import 'package:zipting/app/data/provider/wishlist/wishlist_provider.dart';
import 'package:zipting/main.dart';

class MyPageSearchRecentAllController extends GetxController {
  late RxList<MyPageSearchRecentAllResponseModel> houses =
      <MyPageSearchRecentAllResponseModel>[].obs;
  ...
  Future<void> handleInitProvider() async {
    try {
      await MyPageSearchRecentAllProvider().dio().then((value) {
